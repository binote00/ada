...
if($OfficierEMID >0)
{
	...
	if($Vehicule >0 and $Reput >0)
	{
        ...
        $query2="INSERT INTO Regiment_IA (CT,Pays,Front,Vehicule_ID,Lieu_ID,Vehicule_Nbr,Placement,HP,Camouflage,Experience,Moral,Distance,Move,Skill,Avions,Autonomie) 
        VALUES (0,'$country','$Front','$Vehicule','$Retraite','$Veh_Nbr','$Placement','$HP',1,'$Experience',100,'$Portee',1,'$Skill_p','$Hydra_Nbr','$Autonomie')";
        $con=dbconnecti();
