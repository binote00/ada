...
if (isset($_SESSION['AccountID']) AND $PlayerID > 0) {
    ...
    if (!$MIA and $_SESSION['Distance'] == 0) {
        ...
        include_once 'view/menu_temps_libre.php';
        if ($Credits < 1)
            ...
            if ($Tab == "forme") {
				...
				<Input type='Radio' name='Action' value='6'><img src='images/CT1.png' title='Montant en Crédits Temps que nécessite cette action'>- <a href='#' class='popup'>Se reposer dans vos quartiers<span>Là au moins, vous ne verrez pas la tête de l'infirmière! Vous récupérez de l'endurance</span></a><br>";
                    ...
                    if ($Credits >= 1) {
                        ?>
                        <Input type='Radio' name='Action' value='1'><img src='images/CT1.png'
                                                                         title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>S'en jeter une au mess<span>Il faut bien remonter le moral des troupes de temps en temps! Par cette action le moral ne peut dépasser 100</span></a>
                        <br>
                    <?
                    }
                    if ($Equipage and $Credits >= 2) {
                        ?>
                        <Input type='Radio' name='Action' value='23'><img src='images/CT2.png'
                                                                          title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Emmener <?
                            echo $Eq_Nom; ?> en virée, il en a bien besoin !<span>Il faut bien remonter le moral des troupes de temps en temps!</span></a>
                        <br>
                    <?
                    }
                    if ($Credits >= 5 and $Datediff > 3) {
                        ?>
                        <Input type='Radio' name='Action' value='48'><img src='images/CT5.png'
                                                                          title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Payer une tournée à toute l'escadrille !<span>Il faut bien remonter le moral des troupes de temps en temps!</span></a>
                        <br>
                    <?
                    }
                    if ($Credits >= 30 and $Datediff > 3) {
                        ?>
                        <Input type='Radio' name='Action' value='948'><img src='images/CT30.png'
                                                                           title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Payer une beuverie à toute l'escadrille !<span>Il faut bien remonter le moral des troupes de temps en temps, mais attention aux effets secondaires!</span></a>
                        <br>
                    <?
                    }
                    if ($Credits >= 1) {
                        ?>
                        <Input type='Radio' name='Action' value='2'><img src='images/CT1.png'
                                                                         title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Secouer ces incapables de la station météo<span>Cela fait du bien au moral, mais risque de vous rendre impopulaire! Par cette action le moral ne peut dépasser 100</span></a>
                        <br>
                    <?
                    }
                    if ($Credits >= 1 and $Commandant != $PlayerID) {
                        ?>
                        <Input type='Radio' name='Action' value='3'><img src='images/CT1.png'
                                                                         title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Se plaindre chez le
                            Commandant<span>Idéal pour se faire remarquer!</span></a><br>
                    <?
                    }
                    if ($Credits >= 1) {
                        ?>
                        <Input type='Radio' name='Action' value='4'><img src='images/CT1.png'
                                                                         title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Faire un tour en <?
                            echo $Veh_faction; ?> parce que vous aimez la vitesse<span>Rien de tel que tester son courage! Par cette action le courage ne peut dépasser 100</span></a>
                        <br>
                    <?
                    }
                    if ($Credits >= 2) {
                        ?>
                        <Input type='Radio' name='Action' value='6'><img src='images/CT2.png'
                                                                         title='Montant en Crédits Temps que nécessite cette action'>-
                        <a href='#' class='popup'>Se reposer dans vos quartiers<span>Là au moins, vous ne verrez pas la tête de l'infirmière! Vous récupérez de l'endurance</span></a>
                        <br>
                    <?
                    }
                    if (($Personnel[7] > 0 or $Pers_Sup) and $Endurance > 5) {
                        ?>
                        <Input type='Radio' name='Action' value='50'><img src='images/CT4p.png'
                                                                          title='Montant en Crédits Temps gagné via cette action'>-
                        <a href='#' class='popup'>Demander au médecin un stimulant pour tenir toute la nuit!<span>Un petit coup de boost! Attention aux effets secondaires!</span></a>
                        <br>
                    <?
                    }
                    if ($Credits >= $CT_Perm and $Avancement > 199) {
                        ?>
                        <Input type='Radio' name='Action' value='20'><img src='images/CT<?
                        echo $CT_Perm; ?>.png' title='Montant en Crédits Temps que nécessite cette action'>- <a href='#'
                                                                                                                class='popup'>Profiter
                            d'une permission bien méritée<span>Idéal pour revenir gonflé à bloc! Récupération de moral et de courage</span></a>
                        <br>
                    <?
                    }
                }
                ...
                <table class='table'>
                        ...
                        <td align='left'>
                            ...
                            if ($Credits >= 4 and $QualitePiste < 100 and $QualitePiste > 0 and $Zone != 6 and $Unite_Type != 10 and $Unite_Type != 12 and $Datediff > 3) {
                                ...
                                <Input type='Radio' name='Action' value='5'
                                       title='Le dévouement pour la cause avant tout!'><img src='images/CT4.png'
                                                                                            title='Montant en Crédits Temps que nécessite cette action'>- Aider les pauvres rampants qui oeuvrent à la remise en état de la piste
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Tour < 100 and $Zone != 6 and $Unite_Type != 10 and $Unite_Type != 12 and $Datediff > 3) {
                                ?>
                                <Input type='Radio' name='Action' value='46'
                                       title='Le dévouement pour la cause avant tout!'><img src='images/CT4.png'
                                                                                            title='Montant en Crédits Temps que nécessite cette action'>- Aider les pauvres rampants qui oeuvrent à la remise en état de la tour de contrôle
                                <br>
                            <?
                            }
                            if ($Credits >= 2 and $Camouflage < 100 and $Zone != 6 and $Unite_Type != 10 and $Unite_Type != 12) {
                                ?>
                                <Input type='Radio' name='Action' value='30'
                                       title='Le dévouement pour la cause avant tout!'><img src='images/CT2.png'
                                                                                            title='Montant en Crédits Temps que nécessite cette action'>- Participer à l'amélioration du camouflage de la base
                                <br>
                            <?
                            }
                            if ($Credits >= 1 and $Couverture) {
                                ?>
                                <Input type='Radio' name='Action' value='32' title='Scramble!'><img src='images/CT1.png'
                                                                                                    title='Montant en Crédits Temps que nécessite cette action'>- Annuler la mission de couverture actuelle de votre pilote
                                <br>
                            <?
                            }
                            if ($Credits >= 1 and $Escorte) {
                                ?>
                                <Input type='Radio' name='Action' value='34' title='Scramble!'><img src='images/CT1.png'
                                                                                                    title='Montant en Crédits Temps que nécessite cette action'>- Annuler la mission d'escorte actuelle de votre pilote
                                <br>
                            <?
                            }
                            if ($Credits >= 1) {
                                ?>
                                <Input type='Radio' name='Action' value='49' title='Annulez tout!'><img
                                        src='images/CT1.png'
                                        title='Montant en Crédits Temps que nécessite cette action'>- Annuler les missions actuelles et rappeler tous les pilotes à la base
                                <br>
                            <?
                            }
                            if ($Credits >= 8 and $Missions_Jour > 0 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='13'
                                       title="Le coût total d'une mission supplémentaire de combat est de 8 CT"><img
                                        src='images/CT4.png'
                                        title='Montant en Crédits Temps que nécessite cette action'>- <?
                                echo $Mission_Sup_Txt; ?><br>
                            <?
                            }
                            if ($Missions_Max < 6 and $Reputation > 50 and $Avancement > 199) {
                                ?>
                                <Input type='Radio' name='Action' value='24'
                                       title="Echanger une mission de combat contre des CT"><img src='/images/M1.png'
                                                                                                 title='Cette action nécessite 1 mission du jour'>
                                <img src='images/CT4p.png'
                                     title='Montant en Crédits Temps gagné via cette action'>- Se mettre à disposition de l'Etat-Major
                                <a href='#' class='popup'><img src='images/help.png'><span>Cette action nécessite au moins 1 CT disponible!</span></a>
                                <br>
                                <?
                                $Valid = true;
                            }
                            if ($Missions_Max < 6 and $Credits >= 4) {
                                ?>
                                <Input type='Radio' name='Action' value='31'
                                       title='Idéal pour envisager une carrière bureaucratique!'><img
                                        src='images/CT4.png'
                                        title='Montant en Crédits Temps que nécessite cette action'><img
                                        src='/images/M1.png'
                                        title='Cette action nécessite 1 mission du jour'>- Passer des heures à potasser les règlements plutôt que de partir en mission
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 49 and $Missions_Max < 6 and $Endurance > 0) {
                                ?>
                                <Input type='Radio' name='Action' value='36'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Suivre un entrainement Commando
                                <br>
                            <?
                            }
                            if ($Credits >= 2 and $Reputation > 99 and $Duperie > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='35'><img src='images/CT2.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Se mettre à disposition de l'Etat-Major pour une mission Commando
                                <br>
                            <?
                            }/*if($Bons_ok){?>
					...
					<?}*/
                            if ($Credits >= 5 and $Brevet > 0 and ($Avancement > 99 or $Reputation > 49) and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='47'><img src='/images/M1.png'
                                                                                  title='Cette action nécessite 1 mission du jour'>- Demander votre mutation
                                <br>
                            <?
                            } ?>
                        </td>
                    ...
                    <tr>
                        <td align='left'>
                            ...
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='37'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Acrobatie des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='14'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Bombardement des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='15'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Détection des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='16'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Navigation des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='17'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Pilotage des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='18'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Tactique des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 4 and $Reputation > 499 and $Avancement > 499 and $Skill > 50 and $Missions_Max < 6) {
                                ?>
                                <Input type='Radio' name='Action' value='19'><img src='images/CT4.png'
                                                                                  title='Montant en Crédits Temps que nécessite cette action'>
                                <img src='/images/M1.png'
                                     title='Cette action nécessite 1 mission du jour'>- Aider à la formation en Tir des pilotes de votre escadrille
                                <br>
                            <?
                            }
                            $con = dbconnecti();
                    ...
                    <tr>
                        <td align='left'>
                            ...
                            if ($Credits >= 2 and $Faction > 0 and $Avancement > 2999) {
                                ?>
                                <Input type='Radio' name='Action' value='7'
                                       title="Besoin de glaner des informations sur l'ennemi?"><img src='images/CT2.png'
                                                                                                    title='Montant en Crédits Temps que nécessite cette action'>- Interroger un prisonnier
                                <br>
                            <?
                            }
                            if ($Credits >= 2 and $As) {
                                ?>
                                <Input type='Radio' name='Action' value='22'
                                       title="Le détail qui peut faire la différence"><img src='images/CT2.png'
                                                                                           title='Montant en Crédits Temps que nécessite cette action'>- Discuter avec <?
                                echo $As; ?><br>
                            <?
                            }
                            if ($Credits >= 4) {
                                ?>
                                <Input type='Radio' name='Action' value='33'
                                       title="Le rat sait où trouver son fromage!"><img src='images/CT4.png'
                                                                                        title='Montant en Crédits Temps que nécessite cette action'>- Fouiller dans les dossiers de l'Etat-Major
                                <br>
                            <?
                            }
                            if ($Credits >= 1) {
                                ?>
                                <Input type='Radio' name='Action' value='8'
                                       title="Le détail qui peut faire la différence"><img src='images/CT1.png'
                                                                                           title='Montant en Crédits Temps que nécessite cette action'>- Rendre visite à l'armurier de l'escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 1) {
                                ?>
                                <Input type='Radio' name='Action' value='9'
                                       title="Le détail qui peut faire la différence"><img src='images/CT1.png'
                                                                                           title='Montant en Crédits Temps que nécessite cette action'>- Rendre visite au mécano de l'escadrille
                                <br>
                            <?
                            }
                            if ($Credits >= 1) {
                                ?>
                                <Input type='Radio' name='Action' value='11'
                                       title="Le détail qui peut faire la différence"><img src='images/CT1.png'
                                                                                           title='Montant en Crédits Temps que nécessite cette action'>- Examiner les avions de l'escadrille
                                <br>
                            <?
                            } ?>
                        </td>
            ...
            <?
                ...
                if ($Pilote_Salon) {
                    ...
                    elseif ($Credits >= 1 and $Avancement > 4999 and $Reputation > 9999)
                        echo "<Input type='Radio' name='Action' value='25' title='Idéal pour se faire des relations!'>- Assister à la réception donnée par le Général commandant la région<br>";
                } elseif ($Assis_Bureau) {
                    if ($Credits >= 1) {
                    ...
                    if ($Credits >= 1) {
                        ?>
                        <Input type='Radio' name='Action' value='27' title="Montrer qui a la classe"><img
                                src='images/CT1.png'
                                title='Montant en Crédits Temps que nécessite cette action'>- Soigner votre look<br>
                    <?
                    }
                    if ($Credits >= 2) {
                        ?>
                        <Input type='Radio' name='Action' value='21'
                               title="Pour ceux pour qui l'honneur n'est pas un vain mot!"><img src='images/CT2.png'
                                                                                                title='Montant en Crédits Temps que nécessite cette action'>- Demander à faire partie de l'escorte honorant les tombés au champ d'honneur
                        <br>
                    <?
                    }
                    if ($Credits >= 1 and $Victoires) {
                        ?>
                        <Input type='Radio' name='Action' value='28' title="Montrer à ces bleus qui est l'as des as!">
                        <img src='images/CT1.png'
                             title='Montant en Crédits Temps que nécessite cette action'>- Faire peindre vos marques de victoires sur votre appareil
                        <br>
                    <?
                    }
                    if ($Credits >= 2 and $Victoires) {
                        ?>
                        <Input type='Radio' name='Action' value='26' title="Montrer à ces bleus qui est l'as des as!">
                        <img src='images/CT2.png'
                             title='Montant en Crédits Temps que nécessite cette action'>- Vous pavaner au mess en faisant l'éloge de vos propres exploits
                        <br>
                    <?
                    }
                    if ($Credits >= 4 and $Victoires and $Reputation > 999) {
                        ?>
                        <Input type='Radio' name='Action' value='29' title="Le début de la gloire!"><img
                                src='images/CT4.png'
                                title='Montant en Crédits Temps que nécessite cette action'>- Répondre à l'invitation d'une radio locale pour prononcer un discours sur le combat aérien
                        <br>
                    <?
                    }
                    if ($Credits >= 4 and $Probable > 0) {
                        ?>
                        <Input type='Radio' name='Action' value='12' title="A moi!"><img src='images/CT4.png'
                                                                                         title='Montant en Crédits Temps que nécessite cette action'>- User de son influence pour confirmer une victoire probable
                        <br>
                    <?
                    }
                    if ($Favori_General and !$Skill_Fav) {
                        ?>
                        <Input type='Radio' name='Action' value='25'
                               title='Idéal pour se faire des relations!'>- Assister à la réception donnée par le Général commandant la région
                        <br>
                    <?
                    } elseif ($Credits >= 4 and $Avancement > 4999 and $Reputation > 9999) {
                        ?>
                        <Input type='Radio' name='Action' value='25' title='Idéal pour se faire des relations!'><img
                                src='images/CT4.png'
                                title='Montant en Crédits Temps que nécessite cette action'>- Assister à la réception donnée par le Général commandant la région
                        <br>
                    <?
                    }
                }
