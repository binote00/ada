...
if(isset($_SESSION['AccountID'])) {
    ...
    if ($_GET) {
        /*dbconnect();
        $resultv = $dbh->prepare("SELECT ID,Nom,Pays FROM Cible WHERE ID=:cible");
        $resultv->bindParam('cible', $_GET['id'], 1);
        $resultv->execute();
        ...
        <table align="center">
            ...
            <?if($data['mobile'] !=5){?>
                ...
                <tr onmouseover="this.style.background='#FFFFE0'"  onmouseout="this.style.background='#ECDDC1'"><td class='specs' colspan='4'><?echo $Specs;?></td></tr>
