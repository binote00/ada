			...
			if($result)
			{
				while($data=mysqli_fetch_array($result,MYSQLI_ASSOC))
				{
					if($data['Event_Type'] ==44)
                        $modal_txt.="<p>".$data['Heure']." <img src='images/zone7.jpg' alt='ville'> La ville de <b>".$Lieu_Nom."</b> a été revendiquée par les troupes ".Pluriel(GetData("Pays","ID",$data['Avion'],"adj"))." <img src='images/".$data['Avion']."20.gif'></p>";
					elseif($data['Event_Type'] ==116)
                        $modal_txt.="<p>".$data['Heure']." Des troupes ont débarqué dans les environs de <b>".$Lieu_Nom."</b></p>";
					elseif($data['Event_Type'] ==200)
                        $modal_txt.="<p>".$data['Heure']." Des troupes ".Pluriel(GetData("Pays","ID",$data['Avion'],"adj"))." <img src='images/".$data['Avion']."20.gif'> ont été repérées faisant mouvement dans les environs de <b>".$Lieu_Nom."</b></p>";
				}
				mysqli_free_result($result);
			}
            $modal_txt = $Event . $modal_txt;
		}
		else {
