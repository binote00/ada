...
if(isset($_SESSION['AccountID']) AND $PlayerID >0 AND !empty($_POST) AND $ID >0)
{
	...
	{
		$Robustesse=0;
		$Cellule_ori=GetData("Avions_Persos","ID",$ID,"Cellule");
		...
		if($Robustesse !=0)
		{
			UpdateData("Avions_Persos","Robustesse",$Robustesse,"ID",$ID);
			UpdateData("Pilote","S_HP",$Robustesse,"ID",$PlayerID);
		}
		$con=dbconnecti();
		$query_insert="UPDATE Avion,Avions_Persos SET 
		Avions_Persos.Puissance=Avion.Puissance,
		Avions_Persos.Masse=Avion.Masse,
		Avions_Persos.ChargeAlaire=Avion.ChargeAlaire,
		Avions_Persos.VitesseH=Avion.VitesseH,
		Avions_Persos.VitesseB=Avion.VitesseB,
		Avions_Persos.VitesseA=Avion.VitesseA,
		Avions_Persos.VitesseP=Avion.VitesseP,
		Avions_Persos.Alt_ref=Avion.Alt_ref,
		Avions_Persos.Stabilite=Avion.Stabilite,
		Avions_Persos.Maniabilite=Avion.Maniabilite,
		Avions_Persos.ManoeuvreH=Avion.ManoeuvreH,
		Avions_Persos.ManoeuvreB=Avion.ManoeuvreB,
		Avions_Persos.Detection=Avion.Detection,
		Avions_Persos.Plafond=Avion.Plafond,
		Avions_Persos.Autonomie=Avion.Autonomie,
		Avions_Persos.Visibilite=Avion.Visibilite,
		Avions_Persos.Blindage=Avion.Blindage,
		Avions_Persos.ArmePrincipale=Avion.ArmePrincipale,
		Avions_Persos.Arme1_Nbr=Avion.Arme1_Nbr,
		Avions_Persos.Arme1_Mun=Avion.Arme1_Mun,
		Avions_Persos.Munitions1=Avion.Munitions1,
		Avions_Persos.ArmeSecondaire=Avion.ArmeSecondaire,
		Avions_Persos.Munitions2=Avion.Munitions2,
		Avions_Persos.Arme2_Nbr=Avion.Arme2_Nbr,
		Avions_Persos.Arme2_Mun=Avion.Arme2_Mun,
		Avions_Persos.Bombe=0,
		Avions_Persos.Bombe_Nbr=0,
		Avions_Persos.Avion_BombeT=Avion.Avion_BombeT,
		Avions_Persos.Baby=Avion.Baby,
		Avions_Persos.Helice=Avion.Helice,
		Avions_Persos.Train=Avion.Train,
		Avions_Persos.Cellule=Avion.Cellule,
		Avions_Persos.Volets=Avion.Volets,
		Avions_Persos.Voilure=Avion.Voilure,
		Avions_Persos.Verriere=Avion.Verriere,
		Avions_Persos.Viseur=Avion.Viseur,
		Avions_Persos.Moteur=Avion.Moteur,
		Avions_Persos.Reservoir=Avion.Reservoir,
		Avions_Persos.Camouflage=Avion.Camouflage,
		Avions_Persos.Radar=Avion.Radar,
		Avions_Persos.Radio=Avion.Radio,
		Avions_Persos.Navigation=Avion.Navigation
		WHERE Avions_Persos.ID_ref=Avion.ID AND Avions_Persos.ID='$ID'";
	...
	else
	{
		...
		if($Credits >=$malus_ravit)
		{
			$credits_txt=MoveCredits($PlayerID,10,-$malus_ravit);
			$kilos=0;
			//GetData Avion		
			$con=dbconnecti();
			...
			Voilure,Verriere,Detection,Viseur,Camouflage,Baby,ChargeAlaire,Puissance,Masse,Engine_Nbr,Train,Helice FROM Avions_Persos WHERE ID='$ID'");
			mysqli_close($con);
			if($result)
			{
			...
			$Autonomie=0;			
			if($reparer and $Credits >$reparer+$malus_ravit)
			{
				...
				if($Equipage)$Meca=floor(GetData("Equipage","ID",$Equipage,"Mecanique")/10);
				$Robustesse=$Robustesse_ori+($reparer*200)+$Meca+$Personnel[6];
				if($Robustesse >$robmax or $reparer >10 or $reparer <1)$Robustesse=$robmax;
				...
				if(is_numeric($bombes))
				{
					...
					if($bombes >11)
					{
						switch($bombes)
						{
							...
							case 22:
								$Bombe_new=3000;
								$Bombe_new_nbr=$Fret_mun30;
							break;
							case 23:
								$Bombe_new=1500;
								$Bombe_new_nbr=$Fret_mun40;
							break;
						}
					}
					elseif($bombes ==1)
			...
			if($moteur >0)
			{
				...
				$moteur=$Moteur_ori;
			/*PareBrise
			$PareBrise_ori=GetData("Avions_Persos","ID",$ID,"PareBrise");
			if($parebrise >0)
			{
				switch($parebrise)
				{
			...
			if($Massef >0 and $Puissance >0)
			{
				...
				if($ok)
				{
					$titre="Avion personnel mis à jour!";
					...
					$mes.="<p class='lead'>Erreur de mise à jour!</p>";
			}
			else
				$mes.="<p class='lead'>Erreur d'import des données!</p>";
		}
		else
		{
			$mes.="<br>Vous ne possédez pas les crédits temps suffisantes au vu de l'état du réseau de fournitures de pièces.<br>Contactez votre état-major pour leur signaler l'état insuffisant du ravitaillement.";
