...
<h1>Profil</h1>
<h2><? echo $Nom; ?></h2>
	<div id="profil_photo"><?echo $Photo;?></div>
	<div id="profil_infos">
		<table>
			<tr><td><img src='Premium/Logo_ada_mini.png'></td></tr>
			<tr><td><hr></td></tr>
			<tr><th>Engagement</th></tr>
			<tr><td><? echo $Engagement; ?></td></tr>
	...
	<div id="profil_skills">
		<table class="table table-striped">
			<thead><tr><th colspan='4'>Statistiques</th></tr></thead>
			<tr><th align="left">Score</th><th width="120px" align="right"><? echo $Points; ?></th></tr>
			<tr><th align="left">Missions</th><td width="120px" align="right"><? echo $Missions; ?></td></tr>
			<tr><th align="left">Atterrissages réussis</th><td width="120px" align="right"><? echo $Landings; ?></td></tr>
			<tr><th align="left">Raids Diurnes réussis</th><td width="120px" align="right"><? echo $Raids; ?></td></tr>
			<tr><th align="left">Raids Nocturnes réussis</th><td width="120px" align="right"><? echo $Raids_Nuit; ?></td></tr>
			<tr><th align="left">Véhicules détruits</th><td width="120px" align="right"><? echo $Dive; ?></td></tr>
			<tr><th align="left">Victoires confirmées</th><td width="120px" align="right"><? echo $Vic; ?></td></tr>
			<tr><th align="left">Victoires probables</th><td width="120px" align="right"><? echo $Vic_prob; ?></td></tr>
			<tr><th align="left">Reconnaissances réussies</th><td width="120px" align="right"><? echo $Recce; ?></td></tr>
			<tr><th align="left">Abattu</th><td width="120px" align="right"><? echo $Abattu; ?></td></tr>
		</table>
	</div>
	<div id="col_droite">
	<?/*if($Premium){ 
