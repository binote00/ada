...
function GetToolbar($chemin, $PlayerID, $avion, $HP, $Mun1, $Mun2, $essence, $meteo, $alt, $Puissance, $Longitude, $Latitude, $Cible, $Mission_Type, $gaz = 100, $malus_incident = 1, $avion_db = "Avion", $flaps = 0, $pvp = false)
{
    ...
    if ($Stress_Arme1 > 10) {
        $Arme1_nom = '<font color=\'red\'>' . $Arme1_nom . '</font>';
    } elseif ($Stress_Arme1 > 5) {
        $Arme1_nom = '<font color=\'orange\'>' . $Arme1_nom . '</font>';
    }
    if ($Stress_Arme2 > 10) {
        $Arme2_nom = '<font color=\'red\'>' . $Arme2_nom . '</font>';
    } elseif ($Stress_Arme2 > 5) {
        $Arme2_nom = '<font color=\'orange\'>' . $Arme2_nom . '</font>';
    }
