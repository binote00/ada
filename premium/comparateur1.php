...
if (isset($_SESSION['AccountID'])) {
    ...
    include_once __DIR__ . '/../inc/jfv_air_inc.php';
    include_once __DIR__ . '/../inc/jfv_avions.inc.php';
    include_once __DIR__ . '/../inc/jfv_combat.inc.php';
    ...
    if (GetData("Joueur", "ID", $_SESSION['AccountID'], "Premium")) {
        ...
        //Output
        echo "<h1>Avions à comparer</h1>
        <table class='table'>
		<tr>
			<th></th><th><h2>" . $Nom_1 . "</h2></th><th><h2>" . $Nom_2 . "</h2></th>
		</tr>
		<tr>
