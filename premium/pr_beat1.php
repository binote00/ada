...
if($OfficierID >0 or $OfficierEMID >0)
{
	...
	if($Premium >0)
	{
		...
		<tr><th>Troupes</th><th>HP</th><th>AP</th><th>HE<br>Si pas blind�</th><th>APHE<br>Si blind� et perc�</th><th>APC<br>Si blind� � -500m</th><th>APCR<br>Si blind� � -900m</th><th>APDS<br>Si blind�</th><th>HEAT<br>Si blind� � -400m</th></tr>";
		echo $output."</table>";
	}
	else
