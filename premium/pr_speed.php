	...
	if($Premium >0)
	{
		...
		if($avion)
		{
			if($HP)
			{
				...
				if($alt >$Plafond)$img="Le plafond maximal de cet avion �tant de ".$Plafond."m, l'altitude a �t� adapt�e";
				if(!$alt_ref)
				{
				...
				<p class='lead'>Vitesse estim�e : <b>".$Speed."km/h</b></p>";
			}
			else
				$mes="Un avion d�truit a forc�ment une vitesse nulle...";
			echo $mes;
		}
		else
		{
