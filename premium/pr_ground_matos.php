		...
		if($Date_Campagne and $Type >0)
		{
				...
				while($data=mysqli_fetch_array($result,MYSQLI_ASSOC))
				{
					...
					if($Perdus_indiv <$data['Production'] or $mobile ==4 or $mobile ==5)
					{
						...
						if($data['Arme_Art'])
						{
							...
							$Art="<div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$Arme_Art."' aria-valuemin='0' aria-valuemax='25000' style='width: ".$Arme_Art_pr."%'>D�g�ts</div></div>
							<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Portee']."' aria-valuemin='0' aria-valuemax='10000' style='width: ".$Portee_pr."%'>Port�e</div></div>
						...
						if($data['Arme_AT'])
						{
							...
							$AT="<div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$Arme_AT."' aria-valuemin='0' aria-valuemax='25000' style='width: ".$Arme_AT_pr."%'>D�g�ts</div></div>
							<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Portee']."' aria-valuemin='0' aria-valuemax='10000' style='width: ".$Portee_pr."%'>Port�e</div></div>
							<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$Arme_AT_Perf."' aria-valuemin='0' aria-valuemax='255' style='width: ".$Arme_AT_Perf_pr."%'>P�n�tration</div></div>
							<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Optics']."' aria-valuemin='0' aria-valuemax='10' style='width: ".$Bonus_Tir_pr."%; min-width: 20px;'>Tir</div></div>
						...
						if($data['Arme_AA'])
						{
							...
							<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$Arme_AA."' aria-valuemin='0' aria-valuemax='25000' style='width: ".$Arme_AA_pr."%'></div>D�g�ts</div>
							<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Portee']."' aria-valuemin='0' aria-valuemax='10000' style='width: ".$Portee_pr."%'></div>Port�e</div>
						...
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Vitesse']."' aria-valuemin='0' aria-valuemax='100' style='width: ".$data['Vitesse']."%'></div>Vitesse</div>
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Optics']."' aria-valuemin='0' aria-valuemax='10' style='width: ".$Bonus_Tir_pr."%'></div>Tir</div>
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Fiabilite']."' aria-valuemin='-5' aria-valuemax='5' style='width: ".$Fiabilite_pr."%'></div>Fiabilit�</div>
						...
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Fiabilite']."' aria-valuemin='-5' aria-valuemax='5' style='width: ".$Fiabilite_pr."%'></div>Fiabilit�</div>
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Vitesse']."' aria-valuemin='0' aria-valuemax='100' style='width: ".$data['Vitesse']."%'></div>Vitesse</div>";
						$Reco="<div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Detection']."' aria-valuemin='0' aria-valuemax='50' style='width: ".$Det_pr."%'></div>D�tection</div>
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Vitesse']."' aria-valuemin='0' aria-valuemax='100' style='width: ".$data['Vitesse']."%'></div>Vitesse</div>
						...
						<br><div class='progress'><div class='progress-bar' role='progressbar' aria-valuenow='".$data['Fiabilite']."' aria-valuemin='-5' aria-valuemax='5' style='width: ".$Fiabilite_pr."%'></div>Fiabilit�</div>";*/					
						if($data['Type'] ==99)
							$data['Nom'].=" (Aide � neutraliser les saboteurs)";
						elseif($data['Type'] ==98 or $data['Type'] ==92 or $data['Categorie'] ==16 or $data['Categorie'] ==19)
							$data['Nom'].=" (Minage,d�minage,sabotage,r�paration)";
						elseif($data['Type'] ==97)
							$data['Nom'].=" (D�placement doubl� dans montagnes et collines)";							
						$Reput=$data['Reput'];
						if($Reste <10 and $mobile !=4 and $mobile !=5)$Reput*=2;
						$vehs.="<tr><td><img src='images/vehicules/vehicule".$data['ID'].".gif' title='".$data['Nom']."'><br>
						<form><input type='button' value='D�tail' class='btn btn-primary' onclick=\"window.open('cible.php?cible=".$data['ID']."','Fiche','width=820,height=840,scrollbars=1')\"></form></td>";
						...
						elseif($Reste >3 or $mobile ==4 or $mobile ==5)
						{
							...
							if($Cat)
								...
								$vehs.="<td><span title='Votre officier manque de r�putation pour acc�der � cette cat�gorie'>Cat�gorie inaccessible</span></td>";
						}
						elseif($Prod <50)
							$vehs.="<td><span title='Votre nation doit r�parer les usines d�truites'>Usines ".$Prod."%</span></td>";
						else
							$vehs.="<td><span title='Votre nation doit r�parer les mod�les d�truits'>".$Reste." Dispo</span></td>";
						$vehs.="<td>".$AT."</td>";
						$vehs.="<td>".$AA."</td>";
						$vehs.="<td>".$Art."</td>";
						$vehs.="<td>".$Def."</td>
			...
			if($vehs)
			{
				$titre_up="<thead><tr>
						...
						<th width='10%'>Anti-a�rien</th>
						<th width='10%'>Bombardement</th>
						<th width='10%'>D�fensif</th>
						<th width='10%'>Offensif</th>
						<th width='10%'>Raid</th>
						<th width='10%'>Reco</th></tr></thead>";		
				$mes= "<h2>Mat�riel disponible <a href='#' class='popup'><img src='../images/help.png'><span>Changer de mat�riel r�initialise l exp�rience.</span></a></h2>
				<div style='overflow:auto; height: 600px;'><table class='table table-striped'>" .$titre_up.$vehs."</table></div>";
			}
			else
				$mes="Aucun v�hicule de cette cat�gorie n'est disponible";
