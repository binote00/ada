			...
			$Mani=GetMani($Mani,$HP,$HP,1,1,$flaps);
				...
				{*/
					switch($Zone)
					{
						...
						break;
						case 2:
							$mes='<br>Vous tentez d\'atterrir dans une clairi�re aux commandes de votre <b>'.$NomAvion.'</b>.';
							$QualitePiste=mt_rand(10,80);
						break;
						case 3:
							$mes='<br>Vous tentez d\'atterrir dans ces collines bois�es aux commandes de votre <b>'.$NomAvion.'</b>.';
						...
						break;
						case 5:
							$mes='<br>Vous tentez d\'atterrir dans ces montagnes bois�es aux commandes de votre <b>'.$NomAvion.'</b>.';
						...
						break;
						case 8:
							$mes='<br>Vous tentez d\'atterrir en plein d�sert aux commandes de votre <b>'.$NomAvion.'</b>.';
							$QualitePiste=mt_rand(20,80);
						break;
						case 9:
						...
						break;
						case 11:
							$mes='<br>Vous tentez d\'atterrir en plein mar�cage aux commandes de votre <b>'.$NomAvion.'</b>.';
							$QualitePiste=mt_rand(0,20);
						break;
						case 12: case 15:
					...
					if($Zone <12)
					{
						...
						{
							$menu='<b>Avion pos� avec succ�s !</b>';
					...
					{
						$Masse+=$charge;
						//Edit 28.12.2014 : Faciliter l'atterrissage des avions � grande surface alaire
						...
						if($Landing_run >$LongPiste)
							$menu="Crash apr�s une course de ".round($Landing_run)."m";
						elseif($Speed <$Vit_mini)
							$menu="Crash du � une vitesse trop lente de ".$Speed."km/h (au lieu de ".round($Vit_mini)."km/h)";					
						elseif($Landing <0)
							$menu="Crash du � la m�t�o ou � un manque d'exp�rience de pilotage";
						else
						{
							$img=Afficher_Image('images/avions/landing'.$avion.'.jpg','images/avions/decollage'.$avion.'.jpg','Atterrissage',50);
							$menu="Atterrissage r�ussi, apr�s une course de ".round($Landing_run)."m � la vitesse de ".$Speed."km/h";
						}
					}
				//}
				echo '<br>'.$img;
			...
			<tr>
				...
				<td align="left">
					<select name="terrain" class='form-control' style="width: 200px">
						...
						<option value='3'>Colline bois�e</option>
						<option value='8'>D�sert</option>
						<option value='2'>For�t</option>
						<option value='9'>Jungle</option>
						<option value='11'>Mar�cages</option>
						<option value='4'>Montagne</option>
						<option value='5'>Montagne bois�e</option>
