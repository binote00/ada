...
$(document).ready(function () {
    $('#modal-signin').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget);
        var recipient = button.data('country');
        $('#f-country').val(recipient);
        $('.modal-footer').html(recipient);
        $('.modal-flag').html('<img class="img-fluid my-2 mx-auto d-block" src="images/flag' + recipient + '.jpg" align="middle">');
    })
