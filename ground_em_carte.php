...
if ($OfficierID > 0) {
    ...
    echo "<a href='carte_ground.php?map=" . $Front . "&mode=8' class='btn btn-default' target='_blank'><img src='images/map_icon.gif' title='Accéder à la carte (dans un onglet)'></a>";
}