...
if($OfficierEMID >0 xor $OfficierID >0)
{
	...
	$Reg=Insec($_POST['Reg']);
	echo "<h1>Amélioration d'unité EM</h1>";
	if($Vehicule >0 and $Reput >0 and $Reg >0)
	{
		...
		if($Credits >=$Reput) 
		{
			...
			$resultr=mysqli_query($con,"SELECT Vehicule_ID,Experience FROM Regiment_IA WHERE ID='$Reg'");
			mysqli_close($con);
			if($resultr)
			{
			...
			function Veh_family($Veh)
			{
				switch($Veh)
				{
					case 19: case 21: case 81:
						$Veh_family=21; //Sdkfz 7
					break;
					case 22: case 412: case 461: case 462: case 784:
						$Veh_family=22; //Pz I
					break;
					case 23: case 124: case 125: case 248: case 463: case 725: case 785: case 786:
						$Veh_family=23; //Pz II
					break;
					case 24: case 263:
					...
					case 26: case 701:
						$Veh_family=26; //T-13
					break;
					case 27: case 174: case 175:
						$Veh_family=27; //Renault AMR33
					break;
					case 29: case 163: case 164: case 165: case 224: case 264: case 265: case 266: case 549: case 787: case 788: case 789: case 790:
						$Veh_family=29; //Pz III
					break;
					case 30: case 166: case 167: case 168: case 346: case 395: case 520: case 791: case 801:
						$Veh_family=30; //Pz IV
					break;
					case 32: case 782: case 783:
						$Veh_family=32; //Pz38t
					break;
					case 33: case 262:
						$Veh_family=33; //Cruiser II
					break;
					case 36: case 260: case 497:
						$Veh_family=33; //Matilda II
					break;
					case 38: case 169:
						$Veh_family=38; //Hotchkiss H35
					break;
					case 39: case 160: case 796:
					...
					break;
					case 44: case 45: case 177: case 541:
						$Veh_family=44; //Fiat Ansaldo M
					break;
					case 58: case 120: case 214: case 215:
						$Veh_family=215; //Sdkfz 221
					break;
					case 60: case 151: case 748:
						$Veh_family=60; //Autoblinda
					break;
					case 65: case 85: case 180: case 429: case 739:
						$Veh_family=180; //Humber AC
					break;
					case 78: case 79: case 230:
						$Veh_family=78; //Carro Armato
					break;
					case 80: case 436:
						$Veh_family=80; //Sdkfz 10
					break;
					case 91: case 162: case 253:
						$Veh_family=91; //Bren Carrier
					break;
					case 103: case 107: case 153: case 268: case 359: case 407:
						$Veh_family=103; //Soldaten
					break;
					case 104: case 109: case 154: case 361: case 408:
						$Veh_family=104; //Infantrymen
					break;
					case 105: case 110: case 362: case 409:
						$Veh_family=105; //Fantassin
					break;
					case 106: case 111: case 269: case 360: case 411:
					...
					break;
					case 118: case 206: case 237:
						$Veh_family=118; //Opel Blitz
					break;
					case 119: case 781:
						$Veh_family=119; //Kfz
					break;
					case 121: case 222: case 223: case 232: case 384: case 511:
						$Veh_family=121; //Sdkfz 251
					break;
					case 123: case 465: case 737: case 754: case 755: case 756: case 757:
					...
					break;
					case 171: case 172: case 815:
						$Veh_family=171; //B1
					break;
					case 178: case 179: case 453: case 517: case 518:
						$Veh_family=178; //Crusader
					break;
					case 189: case 190: case 380: case 418: case 419: case 521:
						$Veh_family=189; //StuG
					break;
					case 193: case 194: case 350: case 389: case 390: case 499: case 539:
					...
					break;
					case 235: case 236: case 340:
						$Veh_family=235; //2cm Flak30
					break;
					case 256: case 257: case 258:
						$Veh_family=256; //Marder III
					break;
					case 261: case 397: case 454: case 523: case 524: case 525: case 684: case 804:
					...
					break;
					case 293: case 294: case 295: case 296: case 297: case 301: case 333: case 422: case 437:
						$Veh_family=293; //T-26
					break;
					case 298: case 299: case 402:
						$Veh_family=298; //leFH18
					break;
					case 304: case 305: case 306:
						$Veh_family=304; //T-28
					break;
					case 307: case 308: case 309: case 310: case 438:
						$Veh_family=307; //T-34
					break;
					case 314: case 401:
						$Veh_family=314; //T-40
					break;
					case 317: case 318: case 319: case 320: case 321: case 322: case 325:
						$Veh_family=317; //KV-1
					break;
					case 326: case 400:
						$Veh_family=326; //ZiS5
					...
					case 327: case 328:
						$Veh_family=327; //ZiS6
					break;
					case 334: case 335: case 338:
						$Veh_family=334; //Inf
					break;
					case 356: case 357: case 358: case 540:
					...
					break;
					case 464: case 681: case 792:
						$Veh_family=464; //Panther
					break;
					case 473: case 474: case 475: case 450: case 457: case 534: case 546: case 553: case 555: case 556: case 735: case 741: case 765:
						$Veh_family=473; //Sherman
					break;
					case 492: case 493: case 494: case 533: case 545: case 547: case 449:
					...
					break;
					case 590: case 591: case 593: case 594: case 807:
			...
			$query="UPDATE Regiment_IA SET Vehicule_ID='$Vehicule',Vehicule_Nbr='$Veh_Nbr',HP='$HP',Moral=100,Move=1,Distance='$Portee',Experience='$Base_xp',Skill='$Skill_p' WHERE ID='$Reg'";
			$con=dbconnecti();
			$ok2=mysqli_query($con,$query);
			mysqli_close($con);
			if($ok2)
			{
				echo '<div class="alert alert-warning">La Compagnie d\'état-major a été améliorée avec succès !<br>'.$Veh_Nbr.' '.GetVehiculeIcon($Vehicule,$country,0,0,$Front).'</div>';
				if($OfficierEMID)
					UpdateCarac($OfficierEMID,"Credits",-$Reput,"Officier_em");
				/*else
					UpdateCarac($OfficierID,"Credits",-$Reput,"Officier");*/
			}
			else
				echo '<div class="alert alert-danger">Erreur lors de l\'amélioration de la Compagnie d\'état-major !</div>';
			if($OfficierEMID)
				echo "<br><a href='index.php?view=ground_em_ia_list' class='btn btn-default' title='Retour'>Retour</a>";
			/*else
				echo "<br><a href='index.php?view=ground_bat' class='btn btn-default' title='Retour'>Retour</a>";*/
		}
		else
