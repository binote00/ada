...
if($Pilote_pvp >0)
{
	...
	if(!$Equipage)
	{
		...
		<form action="index.php?view=choix_equipage_pvp" method="post">
		...
		<p>Le membre d'équipage vous accompagnera dans vos missions à bord de tout avion multiplaces.<br>Il vous assistera dans vos tâches et vous pourrez lui donner certains ordres.</p>
