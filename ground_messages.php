...
if($Officier >0 or $OfficierEMID >0 or $PlayerID >0)
{
	...
	if($Exped >0)
	{
		...
		?>
		<form action='index.php?view=archiver_msg_gr' method='post'>
		<input type='hidden' name='msg' value="<?=$ID;?>">
		<input type="Submit" value="Effacer" class='btn btn-danger' onclick='this.disabled=true;this.form.submit();'></form>
		<form action='index.php?view=ground_envoyer' method='post'>
		...
		<table class='table'><thead><tr><th colspan="2">Répondre</th></tr></thead></table>
		<table border='0' cellspacing='2' cellpadding='5'>
			<tr><th>Destinataire</th><td align="left"><?=$Expediteur;?></td></tr>
			<tr><th>Sujet</th><td align="left"><input type="text" name="Sujet" value="RE: <?=$Sujet;?>" size="50" class='form-control'></td></tr>
			<tr><th>Message</th><td align="left"><textarea class='form-control' name="msg" rows="5" cols="50"></textarea></td></tr>
