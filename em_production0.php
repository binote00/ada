...
if($OfficierEMID >0)
{
	...
	{
		?><h2>Production aéronautique</h2>
			<form action='index.php?view=em_production' method='post'><table class='table'><thead><tr><th>Type</th></tr></thead>
				<tr><td><select name='type' class='form-control' style='width: 200px'><?echo DoUniqueSelect('Avion_Type','ID','Type',12,'Type');?></select></td></tr>
