...
<table class='table'>
	...
	<tr bgcolor="#CDBDA7">
		...
		<th><form action='index.php?view=output_avions' method='post'><input type='hidden' name='Pays' value="all"><input type='hidden' name='Type' value="all"><input type='hidden' name='Tri' value="6"><input title="Stabilité" type='Submit' value='Stabilite'></form></th>
