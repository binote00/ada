		...
		if($Bat_Veh_Nbr >0)
		{
			if($Faction >0)
			{
				$output="<h2>Rapport à l'état-major</h2><form action='index.php?view=ground_appui1' method='post'>
								...
								Signaler la situation logistique de votre bataillon à votre état-major.  <input type='Submit' value='RAPPORT' class='btn btn-warning' onclick='this.disabled=true;this.form.submit();'></form> Date du dernier rapport envoy� : ".$Rapport;
				...
				if(($Port >0 and $Placement ==4 and $Faction_occupant_port ==$Faction) or ($Plage >0 and $Placement ==11))
				{
					...
					if($choix)
					{
						...
						$carte_txt="carte_ground.php?map=".$Front."&mode=1";
						 $output.="<h2>Demande de transport maritime <a href='help/aide_transit.php' target='_blank' title='Attention, cette action immobilisera votre unité le temps du transit!'><img src='images/help.png'></a></h2>
			...
			if($para and $Credits >=1)
			{
				...
				{
					$carte_txt="carte_ground.php?map=".$Front."&mode=1";
					$output.="<h2>Demande de parachutage <a href='help/aide_transit.php' target='_blank' title='Attention, cette action immobilisera votre unité le temps du transit!'><img src='images/help.png'></a></h2>
					 <form action='index.php?view=ground_appui1' method='post'>
						<input type='hidden' name='Officier' value='".$OfficierID."'>
			...
			{		
				...
				{			
					...
					<a href='help/aide_transit.php' target='_blank' title='Attention, cette action immobilisera votre unité le temps du transit!'><img src='images/help.png'></a></h2><form action='index.php?view=ground_appui1' method='post'>
						<input type='hidden' name='Officier' value='".$OfficierID."'>
